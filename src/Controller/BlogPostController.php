...
class BlogPostController extends AbstractController
{
    ...
    // Route crée et non générée en console pour afficher la liste des articles
    /**
     * @Route("/list", name="listPostsAction", methods={"GET"})
     */
    ...
    //Route crée pour afficher le contenu d'un seul post
    /**
    ...
    public function showPostAction ($id){
        $blogpost = $this->getDoctrine()
            ...
            return $this->render(blog_post/show.html.twig); ['blogpost'=> $blogpost]);
    }
